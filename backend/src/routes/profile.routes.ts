...
import { createBio, getDisplaypicture, updateProfileInfo, uploadDisplayPicture,getUserInfo,suggestUser,updateBio,getFollowers,getFollowing } from "../controller/profile.controller";
const router = Router();
